...
class DinameForm(forms.Form):
    ...
    agentGDP = forms.BooleanField(label="Agent de GDP (origine)", required=False, initial=False)
    GDP_loge = forms.BooleanField(label="Politique logement Rte dans le nouvel emploi", initial= False)
